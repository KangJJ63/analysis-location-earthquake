...
bak폴더가 있는지 확인
"""
if os.path.isdir('C:/earthquake/data/지진옥외대피장소/행정경계/bak'):
    pass
else:
    """
    행정경계 불러오기
    """
    base_path = "C:/earthquake/data/지진옥외대피장소/행정경계/"  # 격자 경로 설정
...
#컬럼명 재정의
bnd_sido.rename(columns = {'BASE_DATE':'base_year','SIDO_CD':'sido_cd','SIDO_NM':'sido_nm'},inplace= True)
...
bnd_sido.to_file(base_path + 'bnd_sido.shp',encoding='cp949')
